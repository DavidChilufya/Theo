        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="panel filterable">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                                <i class="ti-search"></i> With Individual column Search
                            </h3>
                    </div>
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-xs-6">
                                ...
                                <span>E-mail:</span>
                                <input type="text" name="age" placeholder="abc@xyzmail.com" class="form-control input-sm">
                            </div>
                        </div>

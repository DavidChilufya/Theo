        ...
        <div class="row">
            <div class="col-sm-6 col-md-6 col-lg-3">
                <div class="widget-bg-color-icon card-box">
                    <div class="bg-icon bg-warning pull-left">
                        <i class="ti-shopping-cart-full text-white"></i>

                    </div>
                    <div class="text-right">
                        <h3 class="text-dark"><b id="widget_count1">K200, 652</b></h3>
                        <p>To be recieved</p>
                    </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-3">
                <div class="widget-bg-color-icon card-box border_success">
                    ...
                    <div class="text-right">
                        <h3 class="text-success"><b id="widget_count3">K320, 051</b></h3>
             ...
             <div class="col-sm-6 col-md-6 col-lg-3">
                <div class="widget-bg-color-icon card-box border_danger">
                    <div class="text-center">
                        <h3 class="text-danger"><b id="widget_count4">K 4,358</b></h3>
            ...
            <div class="col-sm-6 col-md-6 col-lg-3">
                <div class="widget-bg-color-icon card-box">
                    ...
                    <div class="text-right">
                        <h3 class="text-dark"><b id="widget_count2">76</b></h3>
                        <p class="text-primary">New Clients</p>
                    </div>
                    <div class="clearfix"></div>
                </div>
            </div>
...
import flip from "../vendors/flip/dist/jquery.flip.min.js";
...
import newsticker from "../vendors/jquery-advanced-news-ticker/js/newsTicker.js";
export default {
    name: 'index',
    mounted: function() {
        "use strict";
...
<style src="../vendors/LC-switch/lc_switch.css"></style>
<style src="../assets/css/custom_css/dashboard1.css"></style>
<style src="../assets/css/custom_css/dashboard1_timeline.css" scoped></style>
